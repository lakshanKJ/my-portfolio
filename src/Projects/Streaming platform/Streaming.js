        ...
        <div class={styles['fm-main']}>
            <div className={styles['fm-secondary']}>
                ...
                <div className={styles['cover-image-sector']}>
                        <img src={stream1} alt="stream website" class={styles.image1}></img>
                </div>
                ...
                <div className={styles['pics-main']}>
                    <div className={styles.pics}>
                        <img src={stream2} alt="stream website" class={styles.image2}></img>
                    </div>
                    <div className={styles.pics}>
                        <img src={stream3} alt="stream website" class={styles.image2}></img>
                    </div>
                </div>
            </div>
        </div>
